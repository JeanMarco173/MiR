...
import './App.css';
import { decrement, increment, reset, toggle, incrementAsync } from './features/counterSlice';
    ...
    <div className="App">
      <div>
        ...
        <div>
          ...
          <button onClick={() => dispatch(incrementAsync(1))} className="Button">Increment Async</button>
        </div>
